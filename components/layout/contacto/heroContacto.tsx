...
const Contacto = () => {
  return (
    <section className="relative h-screen text-white px-4 flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <div className="absolute top-[20%] left-[5%] md:left-[0%] w-32 md:w-100 h-auto ">
        <img src="/images/brand.webp" alt="Decoración 1" className="w-full h-auto rounded-lg shadow-2xl" />
      </div>

      <div className="absolute bottom-[1%] left-[20%] md:left-[20%] w-28 md:w-120 h-auto z-10">
        <img src="/images/REDES-NEW.gif" alt="Decoración 2" className="w-full h-auto" />
      </div>

      <div className="absolute bottom-[5%] right-[15%] md:right-[30%] w-100 md:w-70 h-auto shadow-xl">
        <img src="/images/monitor.webp" alt="Decoración 3" className="w-full h-auto rounded-md" />
      </div>

      <div className="absolute bottom-[20%] right-[10%] md:right-[0%] w-100 md:w-80 h-auto ">
      ...
      <div className="relative z-20"> 
        ...
        <button className="mt-12 px-8 py-2 border border-white rounded-full text-[10px] tracking-[0.2em] uppercase hover:bg-white hover:text-black transition-all duration-300">
          Google Maps
        </button>
      </div>
    </section>
