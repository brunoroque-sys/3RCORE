...
export default function FirstLandingSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative min-h-screen w-full py-20 px-6 md:px-12 lg:px-24 overflow-hidden"
    >
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative index-3 text-center px-8 md:px-16 py-12">
            ...
            <p className="text-transparent bg-clip-text bg-gradient-to-r from-[#E91E63] to-[#9C27B0] text-2xl md:text-3xl lg:text-4xl font-medium leading-relaxed">
