    ...
    >
      <div className="max-w-4xl w-full space-y-12">
        ...
        <div ref={contentRef} className="space-y-8">
          <p className="text-lg md:text-base leading-relaxed text-white max-w-4l mx-auto font-light">
            { t('poParraf1')}
          </p>
          <p className="text-lg md:text-base leading-relaxed text-white max-w-4xl mx-auto font-light">
            { t('poParraf2')}
          </p>
          <p className="text-lg md:text-base leading-relaxed text-white max-w-3xl mx-auto font-light">
            { t('poParraf3')}
          </p>
