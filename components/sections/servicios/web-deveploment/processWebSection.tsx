    ...
    <section ref={sectionRef} className="w-full text-white pt-24 font-sans flex flex-col items-center overflow-hidden">
      <div className="max-w-6xl w-full px-10 space-y-24">
        ...
        <div className="text-center space-y-8">
          ...
          <p ref={subheaderRef} className="text-xl lg:text-5xl font-medium leading-tight bg-clip-text text-transparent"style={{backgroundImage: 'linear-gradient(to right, #FF1A55 0%, #9C27B0 70%, #9C27B0 100%)'}}>
            { t('prosubtitle')}
          </p>
        </div>
      ...
      <div ref={imageContainerRef} className="w-full md:h-[25vh] lg:h-[60vh] mt-12 md:mt-24 overflow-hidden">
        <img 
          ref={imageRef}
