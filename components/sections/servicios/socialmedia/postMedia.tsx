...
export default function PostMedia() {
  // Array de posts - puedes cambiar las imágenes fácilmente aquí
  const posts = [
    {
      id: 1,
      image: '/images/social/postIg/img1.webp', // Cambia esta ruta por tu imagen
      username: 'rest.asdeoros',
      caption: 'En As de Oros, nuestra pasión por la gastronomía y la hospitalidad... más'
    },
    {
      id: 2,
      image: '/images/social/postIg/img2.webp', // Cambia esta ruta por tu imagen
      username: 'rest.asdeoros',
      caption: '¿Te atreves a probar algo diferente?... más'
    },
    {
      id: 3,
      image: '/images/social/postIg/img3.webp', // Cambia esta ruta por tu imagen
      username: 'rest.asdeoros',
      caption: 'Celebramos a quienes cultivan nuestra historia... más'
    },
    {
      id: 4,
      image: '/images/social/postIg/img4.webp', // Cambia esta ruta por tu imagen
      username: 'rest.asdeoros',
