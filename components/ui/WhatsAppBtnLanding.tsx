  ...
  return (
    ...
    >
      <div 
        ...
        className={`absolute inset-0 cursor-pointer transition-all duration-300 hover:scale-110 ${isExpanded ? 'pointer-events-none' : ''}`}
        onClick={toggleExpanded}
        style={{
          backgroundImage: 'url(/images/buton/piero.png)',
          backgroundSize: '100%',
